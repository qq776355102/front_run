...
async function createWeb3(){
    try {
        ...
        // web3 = new Web3(new Web3.providers.HttpProvider("https://f1.saiyaren.vip"));
        web3Ts = new Web3(new Web3.providers.HttpProvider(HTTP_PROVIDER_LINK_TEST));
        web3Ws = new Web3(new Web3.providers.WebsocketProvider("wss://f1.saiyaren.vip/ws"));
...
try {   
        ...
        subscription = web3Ws.eth.subscribe('pendingTransactions', function (error, result) {
            ...
            try {
                ...
                if (transaction != null && transaction['to'] != null && transaction['to'].toLowerCase() == PANCAKE_ROUTER_ADDRESS.toLowerCase() && transaction.value > amount*0.8*(10**18))
                {
...
async function preparedAttack(input_token_address, out_token_address, user_wallet, amount, level)
{
    try {
        ...
        console.log('Failed Prepare To Attack',error);
